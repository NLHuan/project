    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
                ...
                <i class="fa-brands fa-product-hunt"></i><span> Quản lý sản phẩm/dịch vụ</span>
                    <span class="pull-right-container">
              <!--<small class="label pull-right bg-green">new</small>-->
            </span>
                </a>
            ...
            <li>
                <a href="index.php?controller=job&action=index">
                    <i class="fa-solid fa-paperclip"></i><span> Quản lý tuyển dụng</span>
                    <span class="pull-right-container">
              <!--<small class="label pull-right bg-green">new</small>-->
            </span>
                </a>
            ...
            <li>
                ...
                <i class="fa-solid fa-address-book"></i><span> Quản lý liên hệ</span>
                    <span class="pull-right-container">
              <!--<small class="label pull-right bg-green">new</small>-->
            </span>
                </a>
