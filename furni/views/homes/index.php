                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <h1 class="display-2 mb-5 animated slideInDown">Whey Protein Giá Siêu Khuyến Mãi</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <h1 class="display-2 mb-5 animated slideInDown">Super Sale Nutricost Hàng cao cấp giá tốt</h1>
                                    <a href="" class="btn btn-primary rounded-pill py-sm-3 px-sm-5">Sản phẩm</a>
                                    <a href="" class="btn btn-secondary rounded-pill py-sm-3 px-sm-5 ms-3">Dịch vụ</a>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-5 mb-4">Lợi ích của việc bổ sung Whey Protein</h1>
                    <p class="mb-4">Whey protein ngày càng trở nên phổ biến đối với những người đam mê thể dục cũng như các vận động viên do mang lại nhiều lợi ích cho sức khỏe. Có nguồn gốc từ sữa trong quá trình làm phô mai, whey protein là một loại protein hoàn chỉnh chứa tất cả 9 axit amin thiết yếu cần thiết cho sự phát triển và phục hồi cơ bắp.</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Tốc độ hấp thụ nhanh</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Tăng cường chức năng miễn dịch và hỗ trợ sức khỏe</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Đảm bảo độ tinh khiết và hiệu quả</p>
    ...
    <div class="container-fluid bg-light bg-icon my-5 py-6">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-3">Cam kết chính hãng</h1>
                <p>Chúng tôi cam kết cung cấp sản phẩm chính hãng, đảm bảo cho quý khách hàng nhận được chất lượng tốt nhất và an toàn nhất.</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        <img class="img-fluid mb-4" src="assets/img/icon-1.png" alt="">
                        <h4 class="mb-3">Độc Quyền Nguyên Liệu Tự Nhiên</h4>
                        <p class="mb-4">Chúng tôi cam kết sử dụng nguồn nguyên liệu tự nhiên và chất lượng cao để sản xuất thực phẩm chức năng tập gym. Tất cả các thành phần trong sản phẩm của chúng tôi đều được chọn lọc cẩn thận và đảm bảo đạt chuẩn chất lượng cao nhất.</p>
                        <a class="btn btn-outline-primary border-2 py-2 px-4 rounded-pill" href="">Đọc thêm</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        <img class="img-fluid mb-4" src="assets/img/icon-2.png" alt="">
                        <h4 class="mb-3">Quy Trình Sản Xuất Kiểm Soát Chặt Chẽ</h4>
                        <p class="mb-4">Chúng tôi tuân thủ các tiêu chuẩn nghiêm ngặt trong quy trình sản xuất, từ việc chọn lựa nguyên liệu đến giai đoạn đóng gói. Mỗi lô sản phẩm được kiểm tra kỹ lưỡng để đảm bảo tính đồng nhất và chất lượng ổn định trước khi đưa ra thị trường.</p>
                        <a class="btn btn-outline-primary border-2 py-2 px-4 rounded-pill" href="">Đọc thêm</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <h4 class="mb-3">Chứng Nhận Chất Lượng và An Toàn</h4>
                        <p class="mb-4">Sản phẩm của chúng tôi được chứng nhận bởi các cơ quan uy tín về chất lượng và an toàn thực phẩm. Chúng tôi tự hào về việc đáp ứng các tiêu chuẩn cao nhất về sự an toàn và hiệu quả của sản phẩm để mang lại sự tin tưởng tuyệt đối cho khách hàng.</p>
                        <a class="btn btn-outline-primary border-2 py-2 px-4 rounded-pill" href="">Đọc thêm</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid bg-light bg-icon py-6 mb-5">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="testimonial-item position-relative bg-white p-5 mt-4">
                    <i class="fa fa-quote-left fa-3x text-primary position-absolute top-0 start-0 mt-n4 ms-5"></i>
                    <p class="mb-4">SSản phẩm này cung cấp cho tôi một loạt các dưỡng chất quan trọng giúp tăng cường cả về cơ bắp và sức khỏe tổng thể. Tôi thực sự cảm thấy thay đổi tích cực từ bên trong ra ngoài, và đó là một cảm giác không thể diễn tả.</p>
                    <div class="d-flex align-items-center">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <p>Khám phá những bài viết mới nhất trên blog của chúng tôi về cách tối ưu hóa kế hoạch ăn uống và lợi ích của thực phẩm hỗ trợ tập thể hình để đạt được sức khỏe và phong cách sống cân đối.</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid" src="assets/img/blog-1.jpg" alt="">
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">Bí Quyết Lựa Chọn Thực Phẩm Chức Năng Hỗ Trợ Tăng Cơ và Giảm Mỡ</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
                            <small class="me-3"><i class="fa fa-calendar text-primary me-2"></i>27 - 3 - 2024</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">5 Loại Thực Phẩm Hỗ Trợ Phục Hồi Nhanh Chóng Sau Buổi Tập Luyện</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
                            <small class="me-3"><i class="fa fa-calendar text-primary me-2"></i>24 - 3 - 2024</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">Top 10 Thực Phẩm Chức Năng Giúp Tăng Cường Năng Lượng Cho Buổi Tập Thể Hình</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
                            <small class="me-3"><i class="fa fa-calendar text-primary me-2"></i>21 - 3 - 2024</small>
                        </div>
                    </div>
                </div>
            </div>
